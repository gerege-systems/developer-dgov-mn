...
**Government Developer Portal V3.0**-ийн Go backend — *аль ч* цахим төрийн
...
> **Жишиг deployment:** **Government Developer Portal** ([developer.dgov.mn](https://developer.dgov.mn))
...
OAUTH_ISSUER=                    # issuer, жишээ https://developer.dgov.mn (хоосон = provider унтарна)
