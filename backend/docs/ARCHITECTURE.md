...
This document describes the high-level architecture of the **Government Developer
Portal V3.0** (Цахим засаглалыг бүтээх суурь) — a production-ready foundation on
which any digital-government service can be built. Its flagship reference
deployment is **Government Developer Portal** (at **developer.dgov.mn**), an **eID-based
