# Government Developer Portal V3.0 — Backend (Go)
...
The Go backend of the **Government Developer Portal V3.0** — a production-ready
...
> **Reference deployment:** **Government Developer Portal** ([developer.dgov.mn](https://developer.dgov.mn))
...
OAUTH_ISSUER=                    # issuer, e.g. https://developer.dgov.mn (empty = provider off)
