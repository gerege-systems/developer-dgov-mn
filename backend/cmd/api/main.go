...
// Package main нь Government Developer Portal V3.0-ийн API эхлэх цэг юм.
//
...
//
// @title           Government Developer Portal V3.0 API
// @version         1.0
...
//
// @contact.name   Government Developer Portal V3.0
