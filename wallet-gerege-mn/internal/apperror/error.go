...
const (
	...
	ErrTypeConflict
	ErrTypeBadRequest
	// ErrTypeServiceUnavailable нь түр зуурын дэд бүтцийн саатлыг (жишээ нь
	// brute-force тоологчийн Redis backend хүрэлцэхгүй) илэрхийлнэ. 503 болж
	// буудаг тул клиент дахин оролдохыг ойлгоно. Аюулгүйн шалгалт хийж
	// чадахгүй үед хандалт нээхийн оронд татгалзаж (fail closed) ашиглана.
...
// ServiceUnavailable нь түр зуурын дэд бүтцийн саатлаас болж хүсэлтийг
// аюулгүйгээр гүйцэтгэж чадахгүй үед (503) буцаана. Аюулгүйн тоологч /
// шалгалт хийгдэхгүй бол хандалт олгохын оронд татгалзахад (fail closed)
// ашиглана.
func ServiceUnavailable(msg string) *DomainError { return New(ErrTypeServiceUnavailable, msg) }
...
// IsType нь err (эсвэл түүний ороосон cause) өгөгдсөн төрлийн DomainError
// мөн эсэхийг мэдээлнэ. Дуудагчид errors.As-ийн стандарт хэв маягийг
// давтахгүйн тулд — жишээ нь "олдсонгүй" салааг бусад алдаанаас ялгахад — нэмэв.
func IsType(err error, t ErrorType) bool {
	var domErr *DomainError
	if errors.As(err, &domErr) {
		return domErr.Type == t
	}
	return false
}
