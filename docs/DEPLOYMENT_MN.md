...
**Government Developer Portal V3.0** (Цахим засаглалыг бүтээх суурь) — цахим
...
SSO_NATIVE_CLIENT_ID=developer-dgov-mn-ios   # mobile PKCE урсгалын Hydra client_id
...
docker logs developer-dgov-mn-hydra-migrate-1 | tail -3       # Hydra schema түрхэгдсэн
docker logs developer-dgov-mn-api-1 2>&1 | grep -i error      # хоосон байх ёстой
...
**Government Developer Portal V3.0** — **Gerege Systems Development Team** болон **Claude AI** хамтран бүтээв, 2026.
