...
> **Add national eID sign-in to your app** — **eID based · AI enabled** — an
> identity portal for developers over OAuth2 / OpenID Connect.

**Government Developer Portal** is the developer portal for adding national
electronic-ID (eID) sign-in to your application over OAuth2 / OpenID Connect:
register your app, grab your client_id and secret, and receive verified user
identity as standard claims. Under the hood it is a Clean-Architecture Go
backend + Next.js BFF frontend + Gemini AI pipeline — security-hardened and
production-ready. The portal runs at
[developer.dgov.mn](https://developer.dgov.mn), showcasing eID sign-in and the
OIDC provider flow in production.
...
**Government Developer Portal V3.0** — Co-developed by the **Gerege Systems
