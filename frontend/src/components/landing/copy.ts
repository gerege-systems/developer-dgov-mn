...
const mn: LandingCopy = {
  ...
  chat: {
    ...
    greeting: 'Сайн байна уу! Энэ платформын талаар юу ч асууж болно — нэвтрэх шаардлагагүй.',
...
const en: LandingCopy = {
  ...
  chat: {
    ...
    greeting: 'Hi! Ask anything about this platform — no sign-in required.',
...
const zh: LandingCopy = {
  ...
  chat: {
    ...
    title: 'AI 助手',
    sub: '无需登录即可提问',
    greeting: '您好！关于本平台的任何问题都可以问我 — 无需登录。',
    placeholder: '请输入您的问题…',
    send: '发送',
    thinking: '正在思考…',
    error: '获取回复失败，请稍后再试。',
...
const ru: LandingCopy = {
  ...
  chat: {
    ...
    greeting: 'Здравствуйте! Спросите что угодно об этой платформе — вход не требуется.',
